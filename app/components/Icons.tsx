...
export const TrainIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
...
export const PlaneIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-1.1.1-1.5.5l-.3.3c-.4.4-.4 1.1 0 1.5L9 12l-4 4H2.5L2 17l1.5 1.5L5 18v-2.5l4-4 3.8 6c.4.4 1.1.4 1.5 0l.3-.3c.4-.4.6-1 .5-1.5z" />
  </svg>
);
...
export const SwapIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const TicketIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ShieldIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const AlertIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const LoaderIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const MapPinIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
